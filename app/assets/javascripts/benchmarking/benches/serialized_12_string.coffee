...
Benches.setupSerialized12String = (next) ->
...
Benches.beforeSerialized12String = (next) ->
  changeRate = 0.125
  # create the original data version
  @originalVersion = Util.randomObject(typeOdds: [0, 0, 1, 2])
  # handle local update
...
Benches.serialized12String = (next) ->
  try
