...
Benches.setupAttribute25String = (next) ->
...
Benches.beforeAttribute25String = (next) ->
  @answerOriginal = Util.randomObject(typeOdds: [0, 0, 1, 2])
  @answer = new @Answer _.deepClone @answerOriginal
  # perform the winning update
  [@dummyOriginal, deleted] = Util.randomVersion(@answerOriginal, change: 0.25)
...
Benches.attribute25String = (next) ->
  try
