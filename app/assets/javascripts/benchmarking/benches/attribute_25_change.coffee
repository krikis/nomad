...
Benches.setupAttribute25Change = (next) ->
...
Benches.beforeAttribute25Change = (next) ->
  @answerOriginal = Util.randomObject()
  @answer = new @Answer _.deepClone @answerOriginal
  # perform the winning update
  [@dummyOriginal, deleted] = Util.randomVersion(@answerOriginal, change: 0.25, changeOdds: [0, 1, 0])
  @dummy = new @Answer _.deepClone @dummyOriginal
  # perform the losing update
  [version, deleted] = Util.randomVersion(@answerOriginal, change: 0.25, changeOdds: [0, 1, 0])
  @answer.set version
  _.each deleted, (property)=>
    @answer.unset property
  next.call @

Benches.attribute25Change = (next) ->
  try
